...
export const skillText = [
    {
        ...
        desc: (
            <div>
                ...
                <b>의정부 공업 고등학교</b>  스마트 전자과 2015.03 ~ 2018.02 (졸업)
                <hr />
                   <br/>
                 <h3> 교육 과정 :</h3>
                의정부 그린컴퓨터 아카데미:<br />
                <b>(기업수요)Open API를 활용한 Java(자바) 기반 풀스택 개발자 양성과정</b> <br/>
                2023.04.25 ~ 2023.10.31(수료)
                <hr />
                 <h3> My Stacks </h3>
                <h4>Front End </h4><b> HTML5 &ensp; CSS3 &ensp; JAVASCRIPT &ensp; REACT</b><br/>
                   <h4>Back End</h4><b> JAVA &ensp; SPRINGBOOT &ensp; MARIADB &ensp; MYSQL</b>
                <hr />
    ...
    {
        title: "성장 과정.",
        desc: "공동의 목표를 향해 협력하는 모습은 저에게 큰 영감을 주었습니다. 주어진 역할에서 팀원들과 협력하여 프로젝트 목표를 달성하였고, 이러한 경험은 개발자의 꿈과 함께 저의 동기 부여와 새로운 도전에 대한 열정을 높여주었습니다."
    },
    {
        title: "성격 소개. ",
    ...
    {
        title: "직무 능력.",
        desc: "국비지원 개발자 양성 학원에서 웹 개발 분야 강의를 선택하여, 설계 및 관리 등 개발에 필요한 다양한 지식을 습득하고, 효율적인 개발 방법을 터득했습니다. 또한, 프로젝트 진행 중 발생하는 다양한 문제들을 신속하게 해결하며, 문제 해결 역량을 넓혀 나갔습니다."
    },
    {
