...
export const skillText = [
    ...
    {
        title: "성장 과정.",
        desc: "모두가 하나의 목표를 향해서 나아가는게, 인상 깊게 남았습니다. " +
            " '협력'을 최우선으로 생각하며," +
            " '책임감'을 가지고 공동의 목표가 이룰 수 있도록 적극적인 자세로 문제를 해결해 나가겠습니다. "
    },
    {
        title: "성격 소개. ",
        desc: "끈기 있게 문제를 분석 하고, 최선의 방법을 생각합니다." +
              "'열정'그리고 '성실함'을 바탕으로 소통을 중요하게 생각합니다." +
              " 프로젝트 매니저(PM)을 담당하고, 버그 발견 및 수정 하는 과정에서 큰 장점으로 성장 했습니다." +
              " 프로젝트 진행 중 및 종료 후 , 문제점을 분석하고, 팀원에게 피드백을 수용하는 등의 노력을 하며" +
              " 앞으로도 성장할 것 입니다. "
    },
    {
        title: "직무 능력.",
        desc: "국비지원 개발자 양성 학원에서 여러 프로젝트를 수행하면서" +
              "설계 및 관리 등 더욱 상세한 지식을 습득하며 효율적으로 개발하는 방법을 꺠달았습니다." +
              "프로젝트를 진행하면서, 갑작스럽게 생긴 문제를 해결하며, 문제 해결 역량을 넓혀나갔고," +
              "실시간으로 문제를 분석하며, 대응하는 능력을 키웠습니다."
    },
    {
        title: "개발자를 꿈꾸는 사람의 포부",
        desc : "학습 경험과, 여러 프로젝트 수행을 통해 Software 개발의 기초 경험을 다졌습니다." +
               "이러한 경험을 통해 개발자를 꿈꾸는 사람으로써 역량을 더욱 더 강화하고자 하며," +
               "지원한 직무에서는 기술적인 역량을 활용하여 문제를 해결하고, 협력을 통해서 프로젝트를 성공적으로 " +
               "이끌어 나가고자 합니다."
